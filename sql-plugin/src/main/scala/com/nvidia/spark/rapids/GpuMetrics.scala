...
object GpuMetric extends Logging {
  ...
  val FIRST_PASS_SORT_TIME = "firstPassSortTime"
  val FIRST_PASS_SPLIT_TIME = "firstPassSplitTime"
  val MERGE_SORT_TIME = "mergeSortTime"
  val MERGE_SORT_SPLIT_TIME = "mergeSortSplitTime"
  val SORT_CONCAT_TIME = "sortConcatTime"
  ...
  val DESCRIPTION_FIRST_PASS_SORT_TIME = "[ooc] first pass sort time"
  val DESCRIPTION_FIRST_PASS_SPLIT_TIME = "[ooc] first pass split time"
  val DESCRIPTION_MERGE_SORT_TIME = "[ooc] merge sort time"
  val DESCRIPTION_MERGE_SORT_SPLIT_TIME = "[ooc] merge sort split time"
  val DESCRIPTION_SORT_CONCAT_TIME = "[ooc] sort concat output time"
