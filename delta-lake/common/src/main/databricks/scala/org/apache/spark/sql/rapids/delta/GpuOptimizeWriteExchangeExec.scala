...
case class GpuOptimizeWriteExchangeExec(
    ...
    override val child: SparkPlan) extends Exchange with NonColumnarOutputExec {
  import GpuMetric._
  ...
  override lazy val opMetrics : Map[String, GpuMetric] = {
    ...
    // ShuffleExchangeExec overrides base metrics, in order to track the size metrics of
    // the shuffle write stage.
  ...
  private lazy val serializer: Serializer =
    new GpuColumnarBatchSerializer(opMetrics,
